		...
		try {
			...
			if(valid1 && valid2) {
				...
				if(pagamento_no_site.equals("true")) {
					texto = "Você já pagou pela reserva, mas pode deixar que cuidaremos de tudo pra você! <br><br>Faremos o estorno do valor para o cartão utilizado na reserva e o valor estará disponível na sua fatura em até 10 dias úteis! ";
				}
